 ...
 */
class DomainReputationResponseTrustSignalsSignalsNeutralItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<DomainReputationResponseTrustSignalsSignalsNeutralItemPolarity> $polarity Polarity of the signal.
     */
     ...
     *   code: string,
     *   weight: int,
     *   polarity: value-of<DomainReputationResponseTrustSignalsSignalsNeutralItemPolarity>,
     *   category: string,
     *   evidence: string,
     *   confidence: float,
     * } $values
