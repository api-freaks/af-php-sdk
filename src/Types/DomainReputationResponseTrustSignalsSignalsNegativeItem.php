 ...
 */
class DomainReputationResponseTrustSignalsSignalsNegativeItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<DomainReputationResponseTrustSignalsSignalsNegativeItemPolarity> $polarity Polarity of the signal.
     */
     ...
     *   code: string,
     *   weight: int,
     *   polarity: value-of<DomainReputationResponseTrustSignalsSignalsNegativeItemPolarity>,
     *   category: string,
     *   evidence: string,
     *   confidence: float,
     * } $values
