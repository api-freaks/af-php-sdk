...
class CurrentWeatherResponseCurrent extends JsonSerializableType
{
    ...
    /**
     * @var CurrentWeatherResponseCurrentAstronomy $astronomy Astronomical information including sunrise, sunset, and moon phases for the current date.
     */
    #[JsonProperty('astronomy')]
    public CurrentWeatherResponseCurrentAstronomy $astronomy;

    /**
     * @var CurrentWeatherResponseCurrentAirQuality $airQuality Air quality metrics including pollutant concentrations and AQI values.
     */
    #[JsonProperty('air_quality')]
    public CurrentWeatherResponseCurrentAirQuality $airQuality;
