...
class GeocoderSearchResponseItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<GeocoderSearchResponseItemPoiItem> $poi Array describing the main POI and closely related elements at this location.
     */
    #[JsonProperty('poi'), ArrayType([GeocoderSearchResponseItemPoiItem::class])]
    public ?array $poi;
    ...
    /**
     * @var ?string $area Intra-city area below city level, e.g., suburb, borough, ward, district, tehsil, neighbourhood.
     */
    #[JsonProperty('area')]
    public ?string $area;
    ...
    /**
     * @var ?string $county Second-tier administrative area, e.g., county, district, prefecture.
     */
    #[JsonProperty('county')]
    public ?string $county;

    /**
     * @var ?string $stateCode Subdivision code, typically ISO-3166-2 (e.g., US-TX, PK-PB).
     */
    #[JsonProperty('state_code')]
    public ?string $stateCode;

    /**
     * @var ?string $state First-tier administrative area, e.g., state, region, province, division.
     */
    #[JsonProperty('state')]
    public ?string $state;
    ...
    /**
     * @var array<string> $boundingBox Extent of the feature as [lat_min, lat_max, lon_min, lon_max] in WGS84 decimal degrees.
     */
     ...
     *   category?: ?string,
     *   type?: ?string,
     *   poi?: ?array<GeocoderSearchResponseItemPoiItem>,
     *   street?: ?string,
     *   area?: ?string,
     *   postcode?: ?string,
     *   city?: ?string,
