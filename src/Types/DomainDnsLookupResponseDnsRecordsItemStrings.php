...
class DomainDnsLookupResponseDnsRecordsItemStrings extends JsonSerializableType
{
    /**
     * @var string $name
     */
    ...
    /**
     * @var value-of<DomainDnsLookupResponseDnsRecordsItemStringsDnsType> $dnsType
     */
     ...
     *   name: string,
     *   type: int,
     *   dnsType: value-of<DomainDnsLookupResponseDnsRecordsItemStringsDnsType>,
     *   ttl: int,
     *   rawText: string,
     *   rRsetType: int,
