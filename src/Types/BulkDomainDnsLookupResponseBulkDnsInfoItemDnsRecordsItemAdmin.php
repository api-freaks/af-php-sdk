...
class BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemAdmin extends JsonSerializableType
{
    /**
     * @var string $name
     */
    ...
    /**
     * @var value-of<BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemAdminDnsType> $dnsType
     */
     ...
     *   name: string,
     *   type: int,
     *   dnsType: value-of<BulkDomainDnsLookupResponseBulkDnsInfoItemDnsRecordsItemAdminDnsType>,
     *   ttl: int,
     *   rawText: string,
     *   rRsetType: int,
     *   admin: string,
