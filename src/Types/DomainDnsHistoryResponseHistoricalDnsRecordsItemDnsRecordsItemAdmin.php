...
class DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAdmin extends JsonSerializableType
{
    /**
     * @var string $name
     */
    ...
    /**
     * @var value-of<DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAdminDnsType> $dnsType
     */
     ...
     *   name: string,
     *   type: int,
     *   dnsType: value-of<DomainDnsHistoryResponseHistoricalDnsRecordsItemDnsRecordsItemAdminDnsType>,
     *   ttl: int,
     *   rawText: string,
     *   rRsetType: int,
     *   admin: string,
