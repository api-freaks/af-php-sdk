 ...
 */
class GeolocationLookupV2ResponseTimeZone extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?GeolocationLookupV2ResponseTimeZoneDstStart $dstStart DST transition details (used for both the DST start and DST end transitions).
     */
    #[JsonProperty('dst_start')]
    public ?GeolocationLookupV2ResponseTimeZoneDstStart $dstStart;

    /**
     * @var ?GeolocationLookupV2ResponseTimeZoneDstEnd $dstEnd DST transition details (used for both the DST start and DST end transitions).
     */
    #[JsonProperty('dst_end')]
    public ?GeolocationLookupV2ResponseTimeZoneDstEnd $dstEnd;
     ...
     *   dstStart?: ?GeolocationLookupV2ResponseTimeZoneDstStart,
     *   dstEnd?: ?GeolocationLookupV2ResponseTimeZoneDstEnd,
     * } $values
     */
