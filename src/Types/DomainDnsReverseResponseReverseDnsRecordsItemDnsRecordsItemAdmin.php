...
class DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAdmin extends JsonSerializableType
{
    /**
     * @var string $name
     */
    ...
    /**
     * @var value-of<DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAdminDnsType> $dnsType
     */
     ...
     *   name: string,
     *   type: int,
     *   dnsType: value-of<DomainDnsReverseResponseReverseDnsRecordsItemDnsRecordsItemAdminDnsType>,
     *   ttl: int,
     *   rawText: string,
     *   rRsetType: int,
     *   admin: string,
