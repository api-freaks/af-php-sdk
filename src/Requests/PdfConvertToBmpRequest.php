...
use Apifreaks\Types\PdfConvertToBmpRequestFormat;
use Apifreaks\Types\PdfConvertToBmpRequestProfile;
use Apifreaks\Utils\File;

class PdfConvertToBmpRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<PdfConvertToBmpRequestFormat> $format Specifies the desired format for the API response. Choose 'json' for a JSON object or 'xml' for an XML structure.
     */
     ...
     * @param array{
     *   apiKey: string,
     *   format?: ?value-of<PdfConvertToBmpRequestFormat>,
     *   fileId?: ?string,
     *   destroy?: ?bool,
     *   output?: ?string,
     *   pages?: ?string,
