...
use Apifreaks\Types\CurrencyFluctuationRequestFormat;
use DateTime;

class CurrencyFluctuationRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<CurrencyFluctuationRequestFormat> $format Format of the response.
     */
     ...
     *   apiKey: string,
     *   startDate: DateTime,
     *   format?: ?value-of<CurrencyFluctuationRequestFormat>,
     *   endDate?: ?DateTime,
     *   base?: ?string,
