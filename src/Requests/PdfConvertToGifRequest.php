...
use Apifreaks\Types\PdfConvertToGifRequestFormat;
use Apifreaks\Types\PdfConvertToGifRequestProfile;
use Apifreaks\Utils\File;

class PdfConvertToGifRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<PdfConvertToGifRequestFormat> $format Specifies the desired format for the API response. Choose 'json' for a JSON object or 'xml' for an XML structure.
     */
     ...
     * @param array{
     *   apiKey: string,
     *   format?: ?value-of<PdfConvertToGifRequestFormat>,
     *   fileId?: ?string,
     *   destroy?: ?bool,
     *   output?: ?string,
     *   pages?: ?string,
     ...
     *   profile?: ?value-of<PdfConvertToGifRequestProfile>,
     *   webhookUrl?: ?string,
