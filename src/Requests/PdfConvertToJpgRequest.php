...
use Apifreaks\Types\PdfConvertToJpgRequestFormat;
use Apifreaks\Types\PdfConvertToJpgRequestProfile;
use Apifreaks\Utils\File;

class PdfConvertToJpgRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<PdfConvertToJpgRequestFormat> $format Specifies the desired format for the API response. Choose 'json' for a JSON object or 'xml' for an XML structure.
     */
    ...
    /**
     * @var ?int $quality Controls JPG compression quality. Higher values yield sharper images with larger file sizes.
     */
    public ?int $quality;
     ...
     * @param array{
     *   apiKey: string,
     *   format?: ?value-of<PdfConvertToJpgRequestFormat>,
     *   fileId?: ?string,
     *   destroy?: ?bool,
     *   output?: ?string,
     *   quality?: ?int,
