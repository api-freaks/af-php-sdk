...
use Apifreaks\Types\PdfConvertToPngRequestFormat;
use Apifreaks\Types\PdfConvertToPngRequestProfile;
use Apifreaks\Utils\File;

class PdfConvertToPngRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<PdfConvertToPngRequestFormat> $format Specifies the desired format for the API response. Choose 'json' for a JSON object or 'xml' for an XML structure.
     */
     ...
     * @param array{
     *   apiKey: string,
     *   format?: ?value-of<PdfConvertToPngRequestFormat>,
     *   fileId?: ?string,
     *   destroy?: ?bool,
     *   output?: ?string,
     *   pages?: ?string,
